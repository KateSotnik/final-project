      ...
      <Row className="justify-content-md-left">
        ...
        <Col xs lg="4">
          <ListGroup className="list-group-flush">
            <ListGroupItem className ="list-group-item-primary"> {POKE_DETAILS_ID} {`${props.info.id}`}</ListGroupItem>
            <ListGroupItem className ="list-group-item-secondary">
              {POKE_DETAILS_ABILITIES} {`${props.info.abilities}`}
            </ListGroupItem>
            <ListGroupItem className="list-group-item-success">{POKE_DETAILS_TYPES} {`${props.info.types}`}</ListGroupItem>
            <ListGroupItem className="list-group-item-danger">{POKE_DETAILS_WEIGHT} {`${props.info.weight}`}</ListGroupItem>
            <ListGroupItem className="list-group-item-warning">{POKE_DETAILS_STATUS} {`${props.info.status}`} </ListGroupItem>
            {checkDateOfCatch()}
          </ListGroup>
        </Col>
      </Row>
